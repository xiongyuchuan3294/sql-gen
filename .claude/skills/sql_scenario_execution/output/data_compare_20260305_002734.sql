...
INSERT OVERWRITE TABLE imd_aml_safe.rrs_aml_risk_rate_current PARTITION (dt='2026-02-01-temp')
SELECT * FROM imd_aml_safe.rrs_aml_risk_rate_current PARTITION (dt='2026-02-01');
